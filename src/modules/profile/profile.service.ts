  ...
  for (const projectData of newProjectsData) {
    ...
    if (existing) {
      await this.projectRepository.update(existing.id, {
        ...
        isFrontend: projectData.isFrontend ?? false,
        isBackend: projectData.isBackend ?? false,
        date: projectData.date ? new Date(projectData.date) : existing.date,
        endDate: projectData.endDate ? new Date(projectData.endDate) : null,
        githubFrontendUrl: projectData.githubFrontendUrl || null,
        githubBackendUrl: projectData.githubBackendUrl || null,
        demoVideo: projectData.demoVideo || null,
        demoImages: projectData.demoImages || [],
        workDone: projectData.workDone || null,
